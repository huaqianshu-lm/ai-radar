...
published_at: "2026-09-21T23:09:20+00:00"
...
The
Jev 1.13 jaggedness
documentation offers useful guidance as to Jev's strengths and weaknesses. It's currently not great with numbers, dates, or "adversarial content".
I think the
decision model
...
Using Jev from LLM
Update 22nd September 2026
: I released
llm-typesafe
, a plugin that adds support for Jev to my
LLM
CLI tool and Python library. Basic usage looks like this:
llm -m jev
'
...
See
the README
for examples of other query types.
Tags:
ai
,
generative-ai
