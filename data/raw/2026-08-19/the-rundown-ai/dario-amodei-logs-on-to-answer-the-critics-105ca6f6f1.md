...
url: "https://www.therundown.ai/p/dario-amodei-logs-on-to-answer-the-critics"
source_url: "https://www.therundown.ai/p/dario-amodei-logs-on-to-answer-the-critics"
canonical_url: "https://www.therundown.ai/p/dario-amodei-logs-on-to-answer-the-critics"
...
*P.S. — We’re hiring for seven open roles at The Rundown!* *Click here* *to view the positions, apply, or refer the best person you know.*
...
**The Rundown:** Anthropic’s CEO Dario Amodei just chimed in on investor Gavin Baker’s X conversation with coworker Sholto Douglas, rejecting that his safety alarms have backfired and saying the only way AI wins trust back is by “actually curing cancer.”
...
**The Rundown**: Memoket Gem is the lightest AI wristband on the market — a 0.4 oz wearable that records your conversations with one press and turns them into instant summaries, action items, and full context across every off-screen meeting. 

**With Memoket Gem, you get:**

- Hands-free capture as a wristband, Apple Watch clip, or pendant
- One connected memory across conversations instead of 100 meeting notes
- Seamless sync with ChatGPT, Claude, Google Calendar, and Notion
- AI agents with full context from your real-life conversations via MCP

__Pre-Order is open__ — get the device, your choice of accessory, and a free year of the app.
...
###### PRESENTED BY SANDBOXAQ

**The Rundown:** Flint AI's open-source CLI helps engineering teams prove their AI agents are reliable before they ship. Find every agent in your codebase, then red-team each one for jailbreaks and data leakage. Make AI earn it.

**Run locally:**

- *flintai scan* finds every agent in your codebase
- *flintai eval* red-teams before ship
- Score reliability before deploying

*pip install flintai-cli* or get started at __flintai.dev__**.**

###### AI & MATH

Image source: Alextownsend.net

**The Rundown:** Beijing neurosurgery resident Shanmu Jin proved Crouzeix’s Conjecture, a matrix problem unsolved since 2004, with GPT-5.6 Sol surfacing the result after a 16-hour autonomous session in ChatGPT Work.
...
- 🚀 GLM-5.3 - Z AI’s open model with strong coding, agentic, cyber capabilities
- 🔊 Pika Audio - Pika’s audio models spanning music, speech, SFX, soundtracks
- 🖥️ Computer History - Turn Mac activity into memory for ChatGPT and Codex
- ⚡️ Gemini Flash 3.7 - Google’s new fast, cheap and capable mid-class model
...
- Read our last AI newsletter: OpenAI feels the frontier need for speed
...
- Today’s AI tool guide: Hand off real work across your apps with Grok Bot
- RSVP to next workshop: Land your first AI consulting gig
