...
canonical_url: "https://ai.meta.com/blog/introducing-muse-spark-msl"
source: "Meta AI Blog"
...
Muse Spark is available today at __meta.ai__ and the Meta AI app. We’re opening a private API preview to select users.
...
Muse Spark is available now, and Contemplating mode will be rolling out gradually in __meta.ai__.

*For more details about our evaluations, __see our methodology document__.
...
**Pre-Training**. The pre-training phase is where Muse Spark acquires its core multimodal understanding, reasoning, and coding abilities — the foundation that reinforcement learning and test-time compute build upon.
...
**Reinforcement Learning.** After pre-training, reinforcement learning (RL) leverages compute to scalably amplify model capabilities. Even though large-scale RL is notoriously prone to instability, our new stack delivers smooth, predictable gains.
