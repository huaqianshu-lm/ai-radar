...
canonical_url: "https://ai.meta.com/blog/scaling-how-we-build-test-advanced-ai"
source: "Meta AI Blog"
...
Advanced models require an advanced approach to safety — one that scales with the technology. Today, we’re detailing that work: our updated __Advanced AI Scaling Framework__, our __Safety & Preparedness Report__ for Muse Spark, and new advances in how our models reason about safety from the ground up, so that as our AI becomes more capable, our protections keep pace.
