...
published_at: "2026-08-30T23:59:47+00:00"
...
(
Update
: Work Cloud is also available from the ChatGPT desktop app, via a
...
files
imagegen
with tips on creating images with the
image_gen
tool
pdf
for both reading and rendering PDFs
Spreadsheets
for manipulating
.xlsx
,
...
for creating ChatGPT Sites
openai-docs
for answering questions about itself
data-analytics:build-dashboard
for building data dashboards
Tags:
ai
,
openai
